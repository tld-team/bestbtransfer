...
{
?>
    <a href="<?php echo esc_url($link['url']); ?>" <?php echo $link['target'] ? 'target="_blank"' : ''; ?> class="border-2 border-button text-white bg-button px-6 py-2 rounded-xl hover:bg-secondary/90 shadow-gold hover:!text-white hover:shadow-lg hover:-translate-y-0.5 active:scale-95 transition-all duration-300 flex items-center justify-center <?php echo esc_attr($class); ?>"><?php echo esc_html($link['title']); ?>
...
?>
    <a
        ...
        class="border-2 border-secondary text-white bg-secondary px-4 py-2 rounded-xl transition-all duration-300 flex items-center justify-center hover:bg-white hover:!text-secondary hover:scale-[1.02] hover:shadow-lg hover:shadow-secondary/20 active:scale-95 <?php echo esc_attr($class); ?>">
